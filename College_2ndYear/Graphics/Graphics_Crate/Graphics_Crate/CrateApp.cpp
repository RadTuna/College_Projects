...
void CrateApp::BuildShapeGeometry()
{
	...
	SubmeshGeometry boxSubmesh1;
	boxSubmesh1.IndexCount = 12;
	boxSubmesh1.StartIndexLocation = 0;
	boxSubmesh1.BaseVertexLocation = 0;

	SubmeshGeometry boxSubmesh2;
	boxSubmesh2.IndexCount = 12;//(UINT)box.Indices32.size();
	boxSubmesh2.StartIndexLocation = 12;
	boxSubmesh2.BaseVertexLocation = 0;

	SubmeshGeometry boxSubmesh3;
	boxSubmesh3.IndexCount = 12;//(UINT)box.Indices32.size();
	boxSubmesh3.StartIndexLocation = 24;
	boxSubmesh3.BaseVertexLocation = 0;
	
	geo->DrawArgs["box1"] = boxSubmesh1;
...
void CrateApp::BuildMaterials()
{
	...
	auto wireCrate = std::make_unique<Material>();
	wireCrate->Name = "wireCrate";
	wireCrate->MatCBIndex = 1;
	wireCrate->DiffuseSrvHeapIndex = 1;
	wireCrate->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	wireCrate->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
	wireCrate->Roughness = 0.2f;

	mMaterials["wireCrate"] = std::move(wireCrate);

	auto tileCrate = std::make_unique<Material>();
	tileCrate->Name = "tileCrate";
	tileCrate->MatCBIndex = 2;
	tileCrate->DiffuseSrvHeapIndex = 2;
	tileCrate->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	tileCrate->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
...
void CrateApp::BuildRenderItems()
{
	...
	boxRitem1->IndexCount = boxRitem1->Geo->DrawArgs["box1"].IndexCount;
	boxRitem1->StartIndexLocation = boxRitem1->Geo->DrawArgs["box1"].StartIndexLocation;
	boxRitem1->BaseVertexLocation = boxRitem1->Geo->DrawArgs["box1"].BaseVertexLocation;
	XMStoreFloat4x4(&boxRitem1->TexTransform, XMMatrixScaling(5.0f, 5.0f, 1.0f));
	mAllRitems.push_back(std::move(boxRitem1));

	auto boxRitem2 = std::make_unique<RenderItem>();
	boxRitem2->ObjCBIndex = 1;
	boxRitem2->Mat = mMaterials["wireCrate"].get();
	...
	XMStoreFloat4x4(&boxRitem2->TexTransform, XMMatrixScaling(5.0f, 5.0f, 1.0f));
	mAllRitems.push_back(std::move(boxRitem2));

	auto boxRitem3 = std::make_unique<RenderItem>();
	boxRitem3->ObjCBIndex = 2;
	boxRitem3->Mat = mMaterials["tileCrate"].get();
	boxRitem3->Geo = mGeometries["boxGeo"].get();
	boxRitem3->PrimitiveType = D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
	boxRitem3->IndexCount = boxRitem3->Geo->DrawArgs["box3"].IndexCount;
	boxRitem3->StartIndexLocation = boxRitem3->Geo->DrawArgs["box3"].StartIndexLocation;
	boxRitem3->BaseVertexLocation = boxRitem3->Geo->DrawArgs["box3"].BaseVertexLocation;
	XMStoreFloat4x4(&boxRitem3->TexTransform, XMMatrixScaling(5.0f, 5.0f, 1.0f));
