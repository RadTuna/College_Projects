...
int main()
{
    ...
    Dijkstra<std::string, WIDTH, HEIGHT> gameMap;
    ...
    std::cout << "Dijkstra Path find start!" << std::endl;
    for (const std::pair<int, int> position : path)
    {
        std::cout << gameMap.GetNode(position) << " -> ";
    }
    std::cout << "\nDijkstra Path find end!" << std::endl;

    std::cout << "\nDijkstra Path Visualize..." << std::endl;
    for (size_t i = 0; i < WIDTH; ++i)
    {
        for (size_t j = 0; j < HEIGHT; ++j)
        {
    ...
    std::cout << "\nDijkstra Path node weight..." << std::endl;
    for (size_t i = 0; i < WIDTH; ++i)
    {
        for (size_t j = 0; j < HEIGHT; ++j)
        {
